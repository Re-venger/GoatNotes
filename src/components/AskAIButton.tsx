...
// import { Fragment, useTransition, useState, useRef } from "react";
...
import { ArrowUpIcon } from "lucide-react";
import { Textarea } from "./ui/textarea";
import { askAIAboutNotesAction } from "@/actions/ai-action";
...
const AskAIButton = ({ user }: Props) => {
  ...
  const handleSubmit = () => {
    ...
    startTransition(async () => {
      ...
      setResponses((prevResponses) => [...prevResponses, safeResponse]);
